...
config_path = '/home/ubuntu/alex/pref_learning/ControlledCarp/configs/coop/pseudo_coop_two_unfrozen.yml'
...
experiments = [{'review': review, 'save_folder': f'ckpts/{review}_two_unfrozen_coop_model', 'minimize': False} for review in reviews]
